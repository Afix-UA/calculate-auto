...
if (form) {
  let extractNumbersFromForm = function(e) {
    e.preventDefault();
    ...
    getInnerData(calculateData(jsonStr));
  }, calculateData = function(data) {
    const obj = JSON.parse(data);
    let startMileage = +obj.start_mileage;
    let fuelQuantity = +obj.fuel_quantity;
    let totalKm = +obj.total_km;
    let loadedKm = +obj.loaded_km;
    let cargo = +obj.cargo;
    let fuelConsumptionEmpty = Math.round(totalKm) * 30 / 100;
    let cargoFuelConsumption = Math.round(loadedKm * cargo * 1.3 / 100);
    let totalFuelConsumption = fuelConsumptionEmpty + cargoFuelConsumption;
    let finalMileage = startMileage + totalKm;
    let remainingFuel = fuelQuantity - totalFuelConsumption;
    return {
      startMileage,
      fuelQuantity,
      totalKm,
  ...
  }, getInnerData = function(_calculateData) {
  ...
  var extractNumbersFromForm2 = extractNumbersFromForm, calculateData2 = calculateData, getInnerData2 = getInnerData;
  form.addEventListener("submit", extractNumbersFromForm);
}
