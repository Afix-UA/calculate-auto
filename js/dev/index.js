...
function calculateDataTonKm(data) {
  ...
  const totalFuelConsumption = fuelConsumptionEmpty + cargoFuelConsumption;
  const finalMileage = startMileage + totalKm;
  const remainingFuel = fuelQuantity - totalFuelConsumption;
...
function calculateDataMotoHours(data) {
  ...
  const PerMH = engineHoursWorked * fuelPerMH;
